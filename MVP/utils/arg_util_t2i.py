...
class Args(Tap):
    data_path: str = "dataset/ILSVRC/Data/CLS-LOC"
    caption_file: str = "text-caption/imagenet"
    synset_file: str = "dataset/LOC_synset_mapping.txt"
    exp_name: str = 'text'
    ...
    # environment
    local_out_dir_path: str = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'log2', 'local_output_t2i_d16')  # [automatically set; don't specify this]
